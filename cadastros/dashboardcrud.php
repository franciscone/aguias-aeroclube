...
<body>
    ...
    <div class="container contact-form">
        ...
        <form method="post" name="dados" action="crud.php?acao=inserir" onSubmit="return enviardados();">
            <h3>C.R.U.D<br>Aba para necessárias atualizações, consultas, inserções e remoções de dados.</h3>
            <div class="row text-center">
                <div class="col">
                    <div class="form-group">
                        <a href='crud/crud.php?acao=selecionar' class='btn btn-danger mt-5 btnContact' role='button'>Nossos Sócios</a>
                    </div>
                    <div class="form-group">
                        <input type="submit" class="btnContact mt-2" formaction='crud/crudalunos.php?acao=selecionar' value="Alunos" />
                    </div>
                    <div class="form-group">
                        <input type="submit" class="btnContact mt-1" formaction='crud/crudpilotos.php?acao=selecionar' value="Pilotos" />
                    </div>
                    <div class="form-group">
                        <input type="submit" class="btnContact mt-1" formaction='crud/crudinstrutor.php?acao=selecionar' value="Instrutores" />
                    </div>
                    <div class="form-group">
                        <input type="submit" class="btnContact mt-1" formaction='crud/crudaulas.php?acao=selecionar' value="Relatórios de Aulas" />
                    </div>
                </div>
            </div>
        </form>
